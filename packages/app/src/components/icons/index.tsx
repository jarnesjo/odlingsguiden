import { Circle, Ellipse, Line, Path, Rect, Svg, SvgText } from 'react-native-svg'
/**
...
export function DormantIcon({ color = '#8B7355', size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      {/* Z z z - vilar */}
      <SvgText x="16" y="8" fill={color} fontSize="6" fontWeight="bold" opacity="0.5">z</SvgText>
      <SvgText x="18.5" y="5.5" fill={color} fontSize="5" fontWeight="bold" opacity="0.35">z</SvgText>
    </Svg>
  )
}
