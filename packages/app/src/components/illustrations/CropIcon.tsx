...
import { AppleIllustration, AppleIcon } from './AppleIllustration'
import { PearIllustration, PearIcon } from './PearIllustration'
import { PlumIllustration, PlumIcon } from './PlumIllustration'
import { CherryIllustration, CherryIcon } from './CherryIllustration'
import { FigIllustration, FigIcon } from './FigIllustration'
import { WalnutIllustration, WalnutIcon } from './WalnutIllustration'
import { HazelnutIllustration, HazelnutIcon } from './HazelnutIllustration'
import { GrapeIllustration, GrapeIcon } from './GrapeIllustration'
...
const cropMap: Record<string, { large: ComponentType<SizeProps>; small: ComponentType<SizeProps> }> = {
  ...
  'apple': { large: AppleIllustration, small: AppleIcon },
  'paron': { large: PearIllustration, small: PearIcon },
  'plommon': { large: PlumIllustration, small: PlumIcon },
  'korsbar': { large: CherryIllustration, small: CherryIcon },
  'fikon': { large: FigIllustration, small: FigIcon },
  'valnot': { large: WalnutIllustration, small: WalnutIcon },
  'hasselnut': { large: HazelnutIllustration, small: HazelnutIcon },
  'vindruva': { large: GrapeIllustration, small: GrapeIcon },
}
