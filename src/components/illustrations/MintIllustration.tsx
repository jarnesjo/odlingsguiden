...
export function MintIllustration({ size = 200 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none">
      ...
      {/* Blomkransar (lila-rosa, typiskt mynta) */}
      ...
      {/* Underjordiska utlopare (hint om spridning) */}
